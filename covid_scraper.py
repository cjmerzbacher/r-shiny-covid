...
def get_now_dataframe(cases_response):
...
def get_time_dataframe(time_response, testing_response):
...
def get_data():
    ...
    time_data = get_time_dataframe(time_response, testing_response)
    now_data = get_now_dataframe(cases_response)

    return [now_data, time_data]